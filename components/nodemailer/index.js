...
module.exports.sendPwdUrl = async (token, user_mail, user_name) => {
  ...
  transporter.sendMail(
    {
      ...
      html:
        `<p>${user_name}님 비밀번호 초기화를 위해서는 아래의 URL을 클릭하여 주세요.</p>` +
  ...
  transporter.sendMail(
    {
      ...
      html:
        `<p>${user_name}님 알바 수락을 원하시면 아래의 URL을 클릭하여 주세요.</p>` +
